...
def new_chat():
    ...
    It clears the current session's ID, effectively starting a new conversation
    without affecting previously saved chats.
    """
...
def chat():
    """
    Handles chat messages, interacts with Google Gemini, and manages chat history.
    """
...
def get_chat_history_summary():
    """
    Returns a summary of all chat sessions for displaying in a history view.
    """
    summary = []
...
def get_chat_session(chat_id):
    """
    Returns the full conversation for a specific chat_id.
    """
